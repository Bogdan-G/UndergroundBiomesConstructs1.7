...
implements ITileEntityProvider {
    ...
    public void register() {
        this.name.register(this.storedID, (Block)this);
    }
    ...
    public void reRegister() {
        this.name.reRegister(this.storedID, (Block)this);
    }
    ...
    public void func_149725_f(World world, int x, int y, int z, int p_149725_5_) {
        ...
        if (entity != null && entity instanceof UndergroundBiomesTileEntity) {
            this.cacheCode(x, y, z, this.ubBlock((IBlockAccess)world, x, y, z), world);
        }
    }
